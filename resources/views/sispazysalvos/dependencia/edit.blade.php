...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Dependencia: {{$facultad->nombre}}  </h3> {{--Esta variable $docente la envia el controller y se obtiene aqui através del metodo edit--}}
			@if (count($errors)>0)
			...
			{!!Form::model($facultad,['method'=>'PATCH','route'=>['dependencia.update',$facultad->id_dependencia]])!!}
            {{Form::token()}}
